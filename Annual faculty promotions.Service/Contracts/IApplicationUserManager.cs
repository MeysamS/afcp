...
namespace Annual_faculty_promotions.Service.Contracts
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// </summary>
        IClaimsIdentityFactory<AppUser, int> ClaimsIdentityFactory { get; set; }
        ...
        /// </summary>
        IUserTokenProvider<AppUser, int> UserTokenProvider { get; set; }
        ...
        /// </summary>
        IDictionary<string, IUserTokenProvider<AppUser, int>> TwoFactorProviders { get; }
        ...
        Task<AppUser> FindCustomByIdAsync(int userId);
        /// <summary>
        ...
        void RegisterTwoFactorProvider(string twoFactorProvider, IUserTokenProvider<AppUser, int> provider);
        ...
        Task<ClaimsIdentity> GenerateUserIdentityAsync(AppUser applicationUser);
